...
def patch_google_sso(monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr("photom.api._auth.sso", PatchedGoogleSSO("client_id", "client_secret"))


class TestAuth:
    """Test suite for authentication endpoints"""

    def test_login_url(self, client: TestClient, monkeypatch: pytest.MonkeyPatch):
        """Test login url"""
    ...
    def test_callback_url_succes(self, client: TestClient, _patch_google_sso):
        """Test login callback"""
    ...
    def test_callback_url_failure(self, client: TestClient, _patch_google_sso):
    ...
    def test_callback_url_success_with_state(self, client: TestClient, _patch_google_sso):
